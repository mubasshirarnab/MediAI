...
<body>
  <iframe src="<?php echo (isset($_SESSION['role']) && $_SESSION['role'] == 'hospital') ? 'hospitalnav.php' : 'navbar.php'; ?>" frameborder="0" style="width:100%;height:80px"></iframe>
  <div class="container">
    <div id="root"></div>
  </div>
  ...
  <script type="text/babel" src="react/CabinList.jsx"></script>
  <script type="text/babel" src="react/CabinBookingForm.jsx"></script>
  <script type="text/babel" src="react/MyBookings.jsx"></script>
  <script type="text/babel" src="react/AppCabinBooking.jsx"></script>
  <script type="text/babel">
    const App = window.Apps.AppCabinBooking;
