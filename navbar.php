...
<header class="navbar">
  ...
  <nav class="navbar-links">
    ...
    if ($role === 'hospital') {
      echo '<a href="admin_cabin_management.php" class="navbar-link" target="_top">Cabins</a>'; // Hospital cabin admin
      echo '<a href="hospital_inventory.php" class="navbar-link" target="_top">Inventory</a>';
      echo '<a href="report_upload.php" class="navbar-link" target="_top">Report Upload</a>';
    } else {
      // Default for patient/doctor: go to cabin booking
      echo '<a href="cabin_booking.php" class="navbar-link" target="_top">Cabins</a>';
    }
    ...
    ?>
    <a href="<?php echo $profile_link; ?>" class="navbar-link" target="_top">Profile</a>
  </nav>
...
<script>
// Highlight active link based on parent window URL
(function(){
  try {
    ...
    links.forEach(function(a){
      ...
      if (href && href !== '#' && href === file) { a.classList.add('active'); }
    });
  } catch (e) { /* no-op */ }
})();
</script>